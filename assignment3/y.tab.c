...
{
  "$end", "error", "$undefined", "FLOAT", "INT", "IDENTIFIER", "EQUAL",
  "TYPE", "OTHER", "'+'", "'-'", "'*'", "'/'", "UMINUS", "'\\n'", "';'",
  "$accept", "lines", "statements", "stmt", "assignment", "declaration",
  "expr", YY_NULLPTR
};
#endif
...
{
     -11,     0,   -11,     7,    -1,   -11,   -11,     9,   -11,   -11,
      -2,   -11,   -11,   -11,   -11,   -11,    -2,     6,   -11,    -2,
      -2,    -2,    -2,     8,     8,   -11,   -11
};
...
{
       2,    13,    14,    15,    11,     3,    18,     4,    16,    23,
      24,    25,    26,    10,     5,    19,    20,    21,    22,    21,
      22,     0,     0,     0,    12
};

static const yytype_int8 yycheck[] =
{
       0,     3,     4,     5,     5,     5,    16,     7,    10,    19,
      20,    21,    22,     6,    14,     9,    10,    11,    12,    11,
      12,    -1,    -1,    -1,    15
};
...
{
       0,    17,     0,     5,     7,    14,    18,    19,    20,    21,
       6,     5,    15,     3,     4,     5,    10,    22,    22,     9,
      10,    11,    12,    22,    22,    22,    22
};
...
#line 71 "3address.y" /* yacc.c:1646  */
    {
        ...
        if(sym_index == -1){
            ...
            fprintf(stderr,"ERROR !\n %s is unknown id. \n",(yyvsp[-2].string_lval)); // input3 내용
            
            exit(0); // 바로 죵료.
        }

        // 3 address code. expr 에서 t0~ 로 수정된다.
        fprintf(stdout,"%s = %s\n",(yyvsp[-2].string_lval),(yyvsp[0].string_lval));
...
#line 93 "3address.y" /* yacc.c:1646  */
    {
        ...
        if(lookup((yyvsp[0].string_lval)) != -1 ){
            
            fprintf(stderr,"ERROR !\n%s is already declared\n",(yyvsp[0].string_lval));
            exit(0);
        }

        strcpy(symbol_table[symbol_length].id_name, (yyvsp[0].string_lval));
        symbol_table[symbol_length].type = (yyvsp[-1].int_lval);
        symbol_length++;
